...
<body>
    ...
    ?>
        <form name="form1" class="fondo" action="enviarContrato.php" method="POST">
            ...
            <div class="form-group">
                ...
                <?php } else { ?>
                    <input type="datetime-local" class="form-control" id="fecha_desde" name="fecha_desde" Required>
                <?php } ?>
            </div>
            <div class="form-group">
                ...
                <?php } else { ?>
                    <input type="datetime-local" class="form-control" id="fecha_hasta" name="fecha_hasta" Required>
                <?php } ?>
    ...
    <?php } else {
        echo "<div class='fs-2'>Error al intentar contratar el Servicio. Porfavor, vuelve a intentarlo.</div>";
    } ?>
