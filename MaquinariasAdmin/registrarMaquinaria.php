        ...
        <form name="form1" action="registrar.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group input ">
                ...
                <select class="form-select input" aria-label="Default select example" name='id_comuna' id="id_comuna" Required>
                    <option class="input" value="" selected>Selecciona una Comuna</option>
                    <?php
                    if (!empty($region)) {
            ...
            <div class="form-group input">
                ...
                <select class="form-select input" aria-label="Default select example" name='tipo' id="tipo" Required>
                    <option class="input" value="" selected>Selecciona un Tipo</option>
                    <?php
            ...
            <div class="form-group input">
                ...
                <input type="text" class="form-control input" id="montoArriendo" name="montoArriendo" placeholder="Ingrese Monto" onkeypress="return event.charCode >= 48 && event.charCode <= 57" Required>
            </div>
            <div class="form-group input">
