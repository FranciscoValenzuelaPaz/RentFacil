  ...
  <body>
    ...
    <div>
      <div class="fs-3 titulo">REGISTRAR MAQUINARIAS</div>

      <button type="button" class="btn btn-success ctrl" onclick="location='registrarMaquinaria.php?id_usuario=<?php echo $id_usuario ?>'">Registrar</button>
    </div>
    ...
    <?php if (!empty($arrayMaquinarias)) { ?>
      <div class="fs-3 titulo">LISTA DE MAQUINARIAS</div>
      <button class="btn btn-info ctrl2" onclick="location='crudMaquinaria.php?id_usuario=<?php echo $id_usuario ?>'">Actualizar Registros</button>
      <div class="">
