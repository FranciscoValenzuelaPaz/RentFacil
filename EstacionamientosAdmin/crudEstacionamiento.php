...
<body>
  ...
  <div>
    <div">
      ...
      <button type="button" class="btn btn-success ctrl" onclick="location='registrarEstacionamiento.php?id_usuario=<?php echo $id_usuario ?>'">Registrar</button>
      <?php
      ...
      <?php if (!empty($arrayEstacionamientos)) { ?>
        ...
        <button class="btn btn-success ctrl2" onclick="location='crudEstacionamiento.php?id_usuario=<?php echo $id_usuario ?>'">Actualizar Registros</button>
