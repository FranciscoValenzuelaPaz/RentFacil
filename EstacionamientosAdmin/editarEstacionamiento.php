<style>
    <?php include("../CSS/AdmineditarEstacionamiento.css"); ?>
</style>
...
<body>
    <div class="container">
        ...
        $id_usuario_estacionamiento = $arrayDatos[0]['id_usuario'];
        $arrayDatos2 = array();
        ...
        <div class="fs-3 titulo">EDITAR ESTACIONAMIENTO</div>
        <form name="form1" action="editar.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group label">
                ...
                <select class="form-select input" aria-label="Default select example" name='id_region' id="id_region" onchange="marcarCiudad(this.value,'<?php echo $id_usuario; ?>','<?php echo $id_estacionamiento; ?>','<?php echo $link_foto; ?>')" Required>
            ...
            <div class="form-group label">
                ...
                <select class="form-select input" aria-label="Default select example" name='id_ciudad' id="id_ciudad" onchange="marcarComuna(this.value,'<?php echo $id_usuario; ?>','<?php echo $region; ?>','<?php echo $id_estacionamiento; ?>','<?php echo $link_foto; ?>')" Required>
            ...
            <div class="form-group label">
                ...
                <select class="form-select input" aria-label="Default select example" name='usuario' id="usuario" Required>
                    ...
                    while ($row = $stmt->fetch()) {
                        ...
                        if($id_usuario_estacionamiento == $row['id_usuario']){
                            echo 'selected';
                        }
                        echo '>' . $nombre . '</option>';
                    }
            ...
            <div class="form-group label">
                ...
                <input type="text" class="form-control input" id="montoArriendo2" name="montoArriendo2" value="<?php echo $arrayDatos[0]['montoArriendo2']; ?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" Required>
            </div>
            <div class="form-group label">
                <label for="descripcion">Descripción</label>
                <textarea class="form-control  input" placeholder="Ingresa Descripción" id="descripcion" name="descripcion" rows="10" cols="50"><?php echo $arrayDatos[0]['descripcion']; ?></textarea>
            </div>
            <div class="form-group label">
