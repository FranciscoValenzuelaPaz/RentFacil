...
<nav class="navbar bg-dark navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="../inicioHome/inicio.php?email=<?php echo $email;?>">Navbar</a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="../Perfiles/editarPerfilFormulario.php?email=<?php echo $email;?>">Maquinarias</a></li>
           <li><a class="dropdown-item" href="../inicioSesion/iniciarSesion.php">Estacionamientos</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
