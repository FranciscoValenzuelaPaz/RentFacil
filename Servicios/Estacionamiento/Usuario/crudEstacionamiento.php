...
<br>
<div class="fs-3">Registrar Estacionamiento</div>
    <br>
 ...
 <?php if(!empty($arrayEstacionamientos)){ ?>   
  <div class="fs-3">Lista de Estacionamientos</div>
    <br>
    <button class="btn btn-success" onclick="location='crudEstacionamiento.php?email=<?php echo $email ?>'">Actualizar Registros</button>
    <br><br>  
...
<table class="table table-hover">
  ...
  <tbody class="table-group-divider">
    <tr>
        <td><div class="celda"><?php echo $estacionamiento['titulo']; ?></div> </td> <!--retorno de mysql-->
        <td><div class=""><?php echo $estacionamiento['fecha']; ?></div> </td>
        <td><div class="celda"><?php echo $estacionamiento['ubicacion']; ?></div> </td>
        <td>
          <div class="celda">
            <?php 
        ...
        <td><div class=""><?php echo "$".$estacionamiento['montoArriendo']; ?></div> </td>
        ...
        <td><div class="descripcion overflow-y-scroll"><?php echo $estacionamiento['descripcion']; ?></div> </td>
        <td><div><?php echo $arrayEstado[$estacionamiento['estado']]; ?> </td>
...
<?php }else{ ?>
  <div class="fs-3">No se encuentrar Estacionamientos Registrados</div>
