...
<body>
    ...
    <form name="form1" action="registrar.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="fs-2 mb-1 mt"><i class="fa-solid fa-warehouse fa-beat-fade"></i> INGRESAR ESTACIONAMIENTO</div>
                ...
                <div class="col-md-4">
                    <div class="custom-column">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="montoArriendo" name="montoArriendo" onkeypress="return event.charCode >= 48 && event.charCode <= 57" Required>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="custom-column">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="montoArriendo2" name="montoArriendo2" onkeypress="return event.charCode >= 48 && event.charCode <= 57" Required>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="custom-column">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Ingresa Descripción" id="descripcion" name="descripcion" rows="1" cols="50"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mt-4">
                    <div class="custom-column">
                        <div class="form-group">
                            ...
                            <input type="button" class="btn btn-outline-secondary" name="cancelar" value="Cancelar" onclick="location.href='crudEstacionamiento.php?id_usuario=<?php echo $id_usuario; ?>'">
                        </div>
                    </div>
                </div>
            </div>
