...
<body>
    ...
    <form name="form1" action="editar.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="fs-2 mb-1 mt"><i class="fa-solid fa-tractor fa-beat-fade"></i> EDITAR MAQUINARIA</div>
        <div class="container_r_maquinaria">
            <div class="row">
                <div class="col-md-4">
                    <div class="custom-column">
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name='id_region' id="id_region" onchange="marcarCiudad(this.value,'<?php echo $id_usuario; ?>','<?php echo $id_maquinaria; ?>','<?php echo $link_foto; ?>')" Required>
                ...
                <div class="col-md-4">
                    <div class="custom-column">
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name='id_ciudad' id="id_ciudad" onchange="marcarComuna(this.value,'<?php echo $id_usuario; ?>','<?php echo $region; ?>','<?php echo $id_maquinaria; ?>','<?php echo $link_foto; ?>')" Required>
                    ...
                    <div class="custom-column">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="button" class="btn btn-outline-secondary" name="cancelar" value="Cancelar" onclick="location.href='crudMaquinaria.php?id_usuario=<?php echo $id_usuario; ?>'">
                            </div>
                        </div>
                    </div>
                </div>
