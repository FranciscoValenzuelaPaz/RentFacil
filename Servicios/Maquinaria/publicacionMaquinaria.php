...
<?php if(count($arrayMaquinarias) > 0 ){ foreach ($arrayMaquinarias as $maquinaria) {
...
tabla_regiones as Region ON Ciudad.id_region=Region.id_region WHERE M.id_comuna='$id_comuna'");
  ...
  <div class="card">
    <div class="jumbotron caja">
      <h1 class="fs-2" style="margin-left: 35px !important;"><?php echo $maquinaria['titulo']; ?></h1>
      <div class="imagen" style="margin-left: 35px !important;"><img src="<?php echo $maquinaria['link_foto']; ?>" alt="FotoPublicacion" class="img-fluid"></div>
      <br>
      <p class="lead" style="margin-left: 35px !important;"><?php echo $maquinaria['descripcion']; ?></p>
      <p class="lead" style="margin-left: 35px !important;"><?php echo "Monto Arriendo: $" . $maquinaria['montoArriendo']; ?></p>
      <hr class="my-4">
      <p style="margin-left: 35px !important;">Combustible: <?php echo $arrayBencina[$maquinaria['bencina']]; ?></p>
      <p style="margin-left: 35px !important;">Tipo: <?php echo $arrayTipos[$maquinaria['tipo']]; ?></p>
      <p style="margin-left: 35px !important;">Ubicación: <?php echo $ubicacionFinal . "/ " . $maquinaria['ubicacion']; ?></p>
    
      <p style="margin-left: 35px !important;">Estado: <?php echo $arrayEstado[$maquinaria['estado']]; ?></p>
      <p style="margin-left: 35px !important;">Fecha de Publicación: <?php echo $maquinaria['fecha']; ?></p>
      ...
      <?php if ($maquinaria['correo'] == $email) { ?>
        <a class="btn btn-success btn-lg" href="Usuario/crudMaquinaria.php?email=<?php echo $email; ?>" role="button" style="margin-left: 35px !important;">Editar</a> 
      <?php }  ?>
      </div>
    </div>
  </div>
