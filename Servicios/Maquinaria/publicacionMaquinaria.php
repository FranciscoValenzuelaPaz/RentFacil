<style>
  <?php include("../../CSS/publicacionMaquinaria.css"); ?><?php include("../../Header-Footer/header6.php"); ?>
</style>
...
<body>
  ...
  <script>
    ...
    if (mensaje == "error_enviar") {
      ...
      //                     `,
      // });
      alert("Error al Enviar Cotización. Porfavor vuelve a intentarlo.")
    }
  ...
  <div class="container">
    ...
    ?>
        ...
        <div class="card">
          <div class="jumbotron">
            <h1 class="fs-1 titulo"><?php echo $maquinaria['titulo']; ?></h1>
            <div><img src="<?php echo $maquinaria['link_foto']; ?>" alt="FotoPublicacion" class="img-fluid imagen "></div>
            ...
            <div class="row mb-3 mt-5">
              <div class="col-md-4">
                <div class="custom-column">
                  <div class="form-group">
                    <?php if ($maquinaria['id_usuario'] != $id_usuario_original) { ?> <a class="btn btn-success btn-lg" href="../../cotizaciones/formularioCotizar.php?id_maquinaria=<?php echo $maquinaria['id_maquinaria']; ?>
                &tipo_servicio=<?php echo $tipo_servicio; ?>&id_usuario=<?php echo $id_usuario; ?>" role="button">Cotizar</a>
                    <?php } else { ?>
                      <a class="btn btn-outline-success btn-lg disabled" href="#" role="button">Cotizar</a>
                    <?php } ?>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="custom-column">
                  <div class="form-group">
                    <?php if ($maquinaria['id_usuario'] != $id_usuario_original) { ?>
                      <a class="btn btn-success btn-lg " href="../../contratos/formularioContrato.php?id_maquinaria=<?php echo $maquinaria['id_maquinaria']; ?>
                &tipo_servicio=<?php echo $tipo_servicio; ?>&id_usuario=<?php echo $id_usuario; ?>" role="button">Contratar</a>
                    <?php } else { ?>
              ...
              <div class="col-md-4">
                <div class="custom-column">
                  ...
                  <?php } ?>
                  <?php if ($maquinaria['id_usuario'] == $id_usuario_original) { ?>
                    <a class="btn btn-outline-info btn-lg disabled" href="Usuario/crudMaquinaria.php?id_usuario=<?php echo $id_usuario; ?>" role="button">Editar</a>
                  <?php } ?>
                  </div>
                </div>
              </div>
  ...
  <!-- Option 2: jQuery, Popper.js, and Bootstrap JS
      ...
      <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js" integrity="sha384/reFTGAW83EW2RDu2S0VKaIzap3H66lZH81PoYlFhbGU+6BZp6G7niu735Sk7lN" crossorigin="anonymous"></script>
      <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.min.js" integrity="sha384-w1Q4orYjBQndcko6MimVbzY0tgp4pWB4lZ7lr30WKz0vr/aWKhXdBNmNb52v7s" crossorigin="anonymous"></script>
      -->
  </div>
</body>
<footer>
